    ...
    <div className="App">
      ...
      <section >
        <ul className="image-list">
          {flagsUrl.map(flag => {
            return <li className="image-list-item" key={flag.country} onClick={() => {
              setcountryCode("")
              setClickedCountryName(flag.country)
            }}>
              <img src={flag.url} alt="flags" />
            </li>
          })}
        </ul>
      </section>
      ...
      <footer>
        ...
        <ul className="footer-list">
          <li>
            <a className="links" href="https://github.com/JantuDeb" target="_blank" rel="noreferrer">
              GitHub
            </a>
          </li>
